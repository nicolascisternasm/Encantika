...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      componente_incompatibilidades: {
        Row: {
          componente_id: string
          incompatible_con_id: string
          motivo: string | null
        }
        Insert: {
          componente_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "componente_incompatibilidades_componente_id_fkey"
          ...
          {
            foreignKeyName: "componente_incompatibilidades_incompatible_con_id_fkey"
            columns: ["incompatible_con_id"]
            isOneToOne: false
            referencedRelation: "componentes"
            referencedColumns: ["id"]
          },
      ...
      componentes: {
        ...
        Relationships: [
          {
            foreignKeyName: "componentes_tipo_componente_id_fkey"
            columns: ["tipo_componente_id"]
            isOneToOne: false
            referencedRelation: "tipo_componentes"
            referencedColumns: ["id"]
          },
        ]
      }
      configuracion_componentes: {
        ...
        Relationships: [
          {
            foreignKeyName: "configuracion_componentes_componente_id_fkey"
            columns: ["componente_id"]
            isOneToOne: false
            referencedRelation: "componentes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "configuracion_componentes_configuracion_id_fkey"
            columns: ["configuracion_id"]
            isOneToOne: false
            referencedRelation: "configuraciones_joya"
            referencedColumns: ["id"]
          },
        ]
      }
      configuracion_tienda: {
        Row: {
          ...
          nav_mostrar_contacto: boolean | null
          nav_mostrar_nosotros: boolean | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "configuracion_tienda_nosotros_seccion1_imagen_id_fkey"
            columns: ["nosotros_seccion1_imagen_id"]
            isOneToOne: false
            referencedRelation: "imagenes_sitio"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "configuracion_tienda_nosotros_seccion2_imagen_id_fkey"
            columns: ["nosotros_seccion2_imagen_id"]
            isOneToOne: false
            referencedRelation: "imagenes_sitio"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "configuracion_tienda_nosotros_seccion3_imagen_id_fkey"
            columns: ["nosotros_seccion3_imagen_id"]
            isOneToOne: false
            referencedRelation: "imagenes_sitio"
            referencedColumns: ["id"]
          },
      ...
      configuraciones_joya: {
        ...
        Relationships: [
          {
            foreignKeyName: "configuraciones_joya_tipo_joya_id_fkey"
            columns: ["tipo_joya_id"]
            isOneToOne: false
            referencedRelation: "tipos_joya"
            referencedColumns: ["id"]
          },
        ]
      }
