...
export default function DesignEditor({ currentTema, currentFuente }: DesignEditorProps) {
  ...
  return (
    <>
      {/* Cargar fuentes de Google para la vista previa */}
            ...
            return (
              ...
              >
                <div
                  style={{
                    border: selected
                      ? `2px solid ${t.vars['--color-acento']}`
                      : '2px solid transparent',
                    outline: selected
                      ? `3px solid ${t.vars['--color-acento']}40`
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {(Object.keys(FUENTES) as FuenteKey[]).map((key) => {
            ...
            return (
              ...
              >
                <p
                  style={{ fontFamily: f.css, fontSize: 28, lineHeight: 1.3 }}
      ...
      <section className="mb-10">
        <h2 className="text-xs uppercase tracking-[.15em] text-stone-400 mb-6">Vista previa</h2>
  ...
  return (
    <div style={{ backgroundColor: t.vars['--color-fondo'], height: 96 }}>
      ...
      <div
        style={{
          backgroundColor: '#fff',
          borderBottom: `1px solid ${t.vars['--color-borde']}`,
          height: 18,
          display: 'flex',
          alignItems: 'center',
          paddingLeft: 8,
      ...
      >
        <div
          style={{
            width: 22,
            height: 3,
            backgroundColor: t.vars['--color-texto'],
            opacity: 0.8,
            borderRadius: 1,
          }}
        />
        ...
        {[0, 1, 2].map((i) => (
          <div
            ...
            style={{
              width: 12,
              height: 3,
              backgroundColor: t.vars['--color-texto-suave'],
              opacity: 0.4,
              borderRadius: 1,
            }}
          />
      ...
      <div style={{ padding: '8px 8px 6px', display: 'flex', flexDirection: 'column', gap: 5 }}>
        ...
        <div
          style={{
            height: 4,
            width: '40%',
            backgroundColor: t.vars['--color-acento'],
            opacity: 0.7,
            borderRadius: 1,
          }}
        />
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              style={{
                flex: 1,
                height: 28,
                backgroundColor: t.vars['--color-tarjeta'],
                borderRadius: 2,
              }}
            />
          ))}
...
function LivePreview({ temaKey, fuenteKey }: { temaKey: TemaKey; fuenteKey: FuenteKey }) {
  ...
  return (
    <div
      style={{
        backgroundColor: t.vars['--color-fondo'],
        border: `1px solid ${t.vars['--color-borde']}`,
        borderRadius: 8,
        overflow: 'hidden',
        maxWidth: 680,
      }}
    >
      ...
      >
        <span style={{ fontFamily: f.css, fontSize: 20, color: t.vars['--color-texto'] }}>
          Encantika
        </span>
          ...
          {['Catálogo', 'Colecciones', 'Arma tu joya'].map((label) => (
            <span
              ...
              style={{
                ...
                color: t.vars['--color-texto-suave'],
              }}
            >
              {label}
            </span>
      ...
      >
        ...
        <p style={{ fontSize: 13, color: t.vars['--color-texto-suave'], marginTop: 4 }}>
        ...
        <div
          style={{
            ...
            border: `1px solid ${t.vars['--color-texto']}`,
            padding: '8px 20px',
            fontSize: 10,
